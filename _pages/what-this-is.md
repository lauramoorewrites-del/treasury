...
The ancients thought of memory as a physical place inside the brain. A set of wax tablets, or a storehouse or *thesaurus*, which is Latin for treasury. Whatever the metaphorical container, it was filled with individual knowledge-entities which are...
...
Like nodes in a network, the memory contains centers of focus that connect radially to associated information. These centers or nodes were each a *commun locis*, or common place. The knowledge-entities were organized this way so that their holder could train his mind toward that centerpoint, and branch out easily in associative directions, fluidly recalling salient information in the moment, on demand. Because the ultimate point of these treasuries, in classical times, was to serve the goals of rhetoric: extemporizing in a learned fashion on any given topic.

Of course, we are no longer called on to extemporize as a form of social discourse. Which is why, over time, the common place concept of memory turned into the commonplace book, an externalized source of information that can be utilized as a memory tool when writing. Today, with information readily at our fingertips, the commonplace book has narrowed again: colloquially, it often refers to a place to write down things of interest. A memory tool, again, but often an ornamental or performative one; an art piece or conversation piece in itself.
